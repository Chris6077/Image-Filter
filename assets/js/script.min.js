...
let median = function(){
    let medobj = new MedianFilter($("#xcount")[0].value, $("#ycount")[0].value, $("#shape")[0].value, $("#mode")[0].value);
    let can = $("#originalcanvas")[0];
    let imageData = can.getContext("2d").getImageData(0,0,can.width, can.height);
    $("#filteredcanvas")[0].getContext("2d").putImageData(medobj.convertImage(imageData,can.width,can.height),0,0);
}
...
function MedianFilter(mwidth, mheight, shape, mode) {
    ...
    this.getMedian = function () {
        ...
        switch (this.histogram[this.medianbin]) {
			...
			default:
                ...
                if(!c) alert("Invalid X/Y values. We can not filter with those values!");
